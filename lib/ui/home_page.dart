      ...
      appBar: AppBar(
        ...
        actions: [
          PopupMenuButton(
            ...
            onSelected: (selected) => _orderList(selected),
          ),
        ],
      ),
    ...
    setState(() {
      switch (option) {
        case OrderOptions.order_a_z:
          return contacts.sort((a, b) => a.name.toLowerCase().compareTo(b.name.toLowerCase()));
          break;
        case OrderOptions.order_z_a:
          return contacts.sort((a, b) => b.name.toLowerCase().compareTo(a.name.toLowerCase()));
          break;
      }
    });
  }
